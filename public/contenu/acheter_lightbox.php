<div class="contenu_acheter acheter">
    <div class="marq_page">
        <div class="etap_current"><span class="etap">étape 1 - </span><span class="etap_title">Commande &AMP; livraison</span></div>
        <div><span class="etap">étape 2 - </span><span class="etap_title">Paiement &AMP; confirmation</span></div>
    </div>
            ...
            <div class="container_marg">
                <div class="ss_contenu content">
                   ...
                   <span class="mode_livrai mode_1">Normal - 3 à 4 jours ouvrés - 8,99 €</span>
                    ...
                    <button type="button" class="btn_etap_suivant" id="acheter_2_lightbox">Suivant</button> 
