        ...
        <div class="container_fond">
            <div class="container_marg">
                <div class="ss_contenu content">
                    ...
                    <div class="recap_1">
                        <span class="intitul">Carte cadeau</span>
                        <span class="intitul poids">1</span>
                    </div>
                    <div class="recap_2">
                        <span class="intitul">Montant</span>
                        <span class="intitul montant">200,00</span>
                        <span class="intitul type">euro</span>
                    </div>
                    <div class="recap_1">
                        <span class="intitul">Livraison<span class="intitul mode">Express</span></span>
                        <span class="intitul prix_mode">8,99</span>
                        <span class="intitul type">euro</span>
                    </div>
                    <div class="recap_3">
                        <span class="intitul">TOTAL</span>
                        <span class="intitul montant">208,99</span>
                        <span class="intitul type">euro</span>
                    </div>
...
<h4 class="titr_03 acha2">Paiement partenaire</h4><span class="info_paiment">Payez par PayPal</span>
	...
	<div class="radio">
		<input type="radio" id="radio4" name="radio" /><label for="radio4"><img src="images/paypal.jpg" alt=""/></label>
                    ...
                    <button type="button" class="btn_etap_precedent" id="comand_carte_lightbox">Précédent</button> 

                    <button type="button" class="btn_etap_suivant" id="comand_succes_lightbox">Valider</button> 
