...
abstract class Application_Model_About_Legal {

    /**
     * Nom d'un élément, utilisé dans les exceptions surtout
     * @var string
     */
    protected $_entityName = "Legal";
    ...
    public function __construct($setId, $overridesActiveField = false) {
        ...
        try{
            ...
            $this->_setTable = new Application_Model_DbTable_About_Legal();
            $this->_translateTable = new Application_Model_DbTable_About_Legal_Translate();
