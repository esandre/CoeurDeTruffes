...
class Application_Model_About_Fonctionnement_Multilang extends Application_Model_About_Fonctionnement {
    ...
    protected function _refresh() {
        try {
            ...
            $availableTranslates = $this->_translateTable->getByFonctionnementId($this->_setId);
    ...
    public static function fetchAll($overridesActiveField) {
        $table = new Application_Model_DbTable_About_Fonctionnement();
    ...
    public static function getLatest(){
        try{
            ...
            if(!$model instanceof self){
                throw new Application_Model_Exception("Can't create an About Fonctionnement Object");
            } else {
                return $model;
            }
        } catch (Zend_Exception $e) {
            throw new Application_Model_Exception("Can't get latest Fonctionnement", null, $e);
        }
    }
