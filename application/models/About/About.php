...
abstract class Application_Model_About_About {

    /**
     * Nom d'un élément, utilisé dans les exceptions surtout
     * @var string
     */
    protected $_entityName = "About";
    ...
    public function __construct($setId, $overridesActiveField = false) {
        ...
        try{
            ...
            $this->_setTable = new Application_Model_DbTable_About_About();
            $this->_translateTable = new Application_Model_DbTable_About_About_Translate();
