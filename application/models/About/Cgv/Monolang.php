...
class Application_Model_About_Cgv_Monolang extends Application_Model_About_Cgv {
    ...
    protected function _refresh() {
        try {
            ...
            $TrRow = $this->_translateTable->getByCgvIdAndLocale($this->_setId, $this->_localeCode);
    ...
    public static function fetchAll($overridesActiveField) {
        $translateTable = new Application_Model_DbTable_About_Cgv_Translate();
    ...
    public static function getLatestByLocale($locale){
        try{
            ...
            throw new Application_Model_Exception("Can't get latest Cgv for locale $locale", null, $e);
        }
    }
