...
class Application_Model_About_About_Monolang extends Application_Model_About_About {
    ...
    protected function _refresh() {
        try {
            ...
            $TrRow = $this->_translateTable->getByAboutIdAndLocale($this->_setId, $this->_localeCode);
    ...
    public static function fetchAll($overridesActiveField) {
        $translateTable = new Application_Model_DbTable_About_About_Translate();
    ...
    public static function getLatestByLocale($locale){
        try{
            ...
            throw new Application_Model_Exception("Can't get latest Abouts for locale $locale", null, $e);
        }
    }
