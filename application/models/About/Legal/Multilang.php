...
class Application_Model_About_Legal_Multilang extends Application_Model_About_Legal {
    ...
    protected function _refresh() {
        try {
            ...
            $availableTranslates = $this->_translateTable->getByLegalId($this->_setId);
    ...
    public static function fetchAll($overridesActiveField) {
        $table = new Application_Model_DbTable_About_Legal();
