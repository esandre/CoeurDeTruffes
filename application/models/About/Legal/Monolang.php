...
class Application_Model_About_Legal_Monolang extends Application_Model_About_Legal {
    ...
    protected function _refresh() {
        try {
            ...
            $TrRow = $this->_translateTable->getByLegalIdAndLocale($this->_setId, $this->_localeCode);
    ...
    public static function fetchAll($overridesActiveField) {
        $translateTable = new Application_Model_DbTable_About_Legal_Translate();
