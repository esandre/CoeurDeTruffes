...
abstract class Application_Model_About_Cgv {

    /**
     * Nom d'un élément, utilisé dans les exceptions surtout
     * @var string
     */
    protected $_entityName = "Cgv";
    ...
    public function __construct($setId, $overridesActiveField = false) {
        ...
        try{
            ...
            $this->_setTable = new Application_Model_DbTable_About_Cgv();
            $this->_translateTable = new Application_Model_DbTable_About_Cgv_Translate();
