...
/**
 * Element de formulaire permettant de saisir et de verifier la validité d'un nom de Pays.
 *
 * @author kryzaal
 */

class Form_Field_Adresse_CountryField extends Zend_Form_Element_Text{
