...
/**
 * Element de formulaire permettant de saisir et de verifier la validité d'un nom de personne.
 *
 * @author kryzaal
 */

class Form_Field_Personne_NomField extends Zend_Form_Element_Text{
